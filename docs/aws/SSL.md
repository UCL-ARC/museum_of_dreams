...
**Once the certificate has been issued, i.e _not_ pending** click on the certificate and click "create records in Route 53". Select applicable domain names and create records, they should show up in your Hosted Zone.

### Attaching to the EB environment

> [NOTE]
> Due to the updated setup using only one EC2 instance, this is not currently used
