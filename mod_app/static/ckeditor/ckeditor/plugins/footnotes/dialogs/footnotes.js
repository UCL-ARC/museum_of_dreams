    ...
    return {
      ...
      onShow: function () {
        ...
        CKEDITOR.replaceAll(function (textarea, config) {
          ...
          config.extraPlugins = "mentions,autocomplete";

          const itemTemplate = '<li data-id="{id}" data-value="{id}">{full_citation}</li>';

          const outputTemplate = '<strong data-bib-id="{id}" class="bib-mention">{short_citation}</strong>';
